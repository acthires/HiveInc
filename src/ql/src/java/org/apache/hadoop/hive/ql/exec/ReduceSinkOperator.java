...
public class ReduceSinkOperator extends TerminalOperator<ReduceSinkDesc>
  ...
  transient private String storeDirName = null; // for store incremental join input
  //transient private QB sourceQB = null; // for gby split cost model
  transient private String taskId = null; // for gby split cost model
