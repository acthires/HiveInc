...
public class PerfLogger {
  ...
  public static final String MULTICOMPILE = "multi compile";
  public static final String MULTIPARSE = "multi parse";
  public static final String MULTIANALYZE1 = "multi semanticAnalyze Phase1";
  public static final String PREOPTTEST = "multi mutilpreoptimizetest";
