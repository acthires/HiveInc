...
public class Context {
  ...
  private final HashSet<String> createdIncInputDirs = new HashSet<String>();
...
//    }else{
      ...
      createdIncInputDirs.add(dirPath.toString());
...
//    }
  ...
  public HashSet<String> getIncInputCacheDir() {
    return createdIncInputDirs;
  }
}
