...
public class QB {
  ...
  String gbyTaskId = null; // for gby split cost model
  private boolean isToDelete = true;
  // used by PTFs
  /*
  ...
  public void setGbyTaskId (String id){
    this.gbyTaskId = id;
  }

  public String getGbyTaskId (){
    return this.gbyTaskId;
  }

  public void setIsToDelete(boolean b){
    this.isToDelete = b;
  }
