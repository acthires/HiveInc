...
public class MapRedStats {
  ...
  public MapRedStats(int numMap, int numReduce, long cpuMSec, boolean ifSuccess, String jobId,long elapse) {
    this.numMap = numMap;
    this.numReduce = numReduce;
    this.cpuMSec = cpuMSec;
    this.success = ifSuccess;
    this.jobId = jobId;
    this.elapseSec = elapse;
  }
  ...
  public String toString() {
    ...
    sb.append(" Elapse: " + elapseSec + " sec ");
    return sb.toString();
  }
